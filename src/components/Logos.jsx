...
export default function Logos(props) {
  ...
  return (
    ...
    <group
      ...
      <mesh name="Curve011" geometry={nodes.Curve011.geometry} material={materials.white2} />
      <mesh name="Curve011_1" geometry={nodes.Curve011_1.geometry} material={materials.blue} />
    </group>
    <group
      name="tailwind"
      position={[-7.36963558, 2.34726548, -6.54181814]}
      rotation={[0, 1.06228973, 0]}>
      <mesh name="Curve014" geometry={nodes.Curve014.geometry} material={materials.blue} />
      <mesh
        name="Curve014_1"
    ...
    <group
      ...
      <mesh name="Curve_1" geometry={nodes.Curve_1.geometry} material={materials['SVGMat.003']} />
      <mesh name="Curve_2" geometry={nodes.Curve_2.geometry} material={materials['SVGMat.004']} />
    </group>
  </group>
  )
}
